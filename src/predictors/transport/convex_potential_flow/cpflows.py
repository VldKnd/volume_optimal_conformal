# code is copied from https://github.com/CW-Huang/CP-Flow/blob/main/lib/flows/cpflows.py
import torch
...
import numpy as np
from predictors.transport.convex_potential_flow.logdet_estimators import (
            ...
            for i in range(f.shape[1]):
                ...
                H.append(
                    torch.autograd.grad(
                        ...
                        x,
                        create_graph=create_graph,
                        retain_graph=create_graph or retain_graph,
                    )[0]
                )
